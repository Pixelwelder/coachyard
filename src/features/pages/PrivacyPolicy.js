const PrivacyPolicy = () => {
  return (
    <div>
        <h1>COACHYARD Privacy Policy</h1>

        <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from https://coachyard.io (the “Site”).</p>
        ...
        <h2>CONTACT US</h2>
        <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at pixelwelders@gmail.com or by mail using the details provided below:</p>

        <p>208 Clinton Ave, Oak Park, IL, 60302, United States</p>
    </div>
  );
};
